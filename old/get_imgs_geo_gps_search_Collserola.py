...
for current_tag in range(0, num_queries):
    ...
    out_file = open('/images/' + pos_queries[current_tag] + '.txt', 'w')
    # out_file = open('F:\Barcelona\THESIS\my new proposal\maps\Flickr\Flickr_code_2009_05_14\images\\' + pos_queries[current_tag] + '.txt','w')
    ###########################################################################
